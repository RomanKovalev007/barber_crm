...
import (
	...
	"github.com/RomanKovalev007/barber_crm/services/booking/internal/migrator"
	"github.com/RomanKovalev007/barber_crm/services/booking/migrations"
)

func main() {
	log := logger.New("booking-migrate")
