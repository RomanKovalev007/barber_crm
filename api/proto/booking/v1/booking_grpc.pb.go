...
type BookingServiceClient interface {
	...
	DeleteBooking(ctx context.Context, in *BookingIdRequest, opts ...grpc.CallOption) (*DeleteResponse, error)
	GetWorkDay(ctx context.Context, in *SlotsRequest, opts ...grpc.CallOption) (*SlotsResponse, error)
	GetFree(ctx context.Context, in *SlotsRequest, opts ...grpc.CallOption) (*SlotsResponse, error)
}
...
func (c *bookingServiceClient) DeleteBooking(ctx context.Context, in *BookingIdRequest, opts ...grpc.CallOption) (*DeleteResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *bookingServiceClient) GetWorkDay(ctx context.Context, in *SlotsRequest, opts ...grpc.CallOption) (*SlotsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SlotsResponse)
	err := c.cc.Invoke(ctx, BookingService_GetWorkDay_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bookingServiceClient) GetFree(ctx context.Context, in *SlotsRequest, opts ...grpc.CallOption) (*SlotsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SlotsResponse)
	err := c.cc.Invoke(ctx, BookingService_GetFree_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BookingServiceServer interface {
	...
	DeleteBooking(context.Context, *BookingIdRequest) (*DeleteResponse, error)
	GetWorkDay(context.Context, *SlotsRequest) (*SlotsResponse, error)
	GetFree(context.Context, *SlotsRequest) (*SlotsResponse, error)
...
func (UnimplementedBookingServiceServer) DeleteBooking(context.Context, *BookingIdRequest) (*DeleteResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteBooking not implemented")
}
func (UnimplementedBookingServiceServer) GetWorkDay(context.Context, *SlotsRequest) (*SlotsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetWorkDay not implemented")
}
func (UnimplementedBookingServiceServer) GetFree(context.Context, *SlotsRequest) (*SlotsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetFree not implemented")
}
...
func _BookingService_GetWorkDay_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SlotsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BookingServiceServer).GetWorkDay(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BookingService_GetWorkDay_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookingServiceServer).GetWorkDay(ctx, req.(*SlotsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _BookingService_GetFree_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SlotsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BookingServiceServer).GetFree(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BookingService_GetFree_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookingServiceServer).GetFree(ctx, req.(*SlotsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BookingService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _BookingService_GetWorkDay_Handler,
		},
		{
			MethodName: "GetFree",
			Handler:    _BookingService_GetFree_Handler,
		},
	},
